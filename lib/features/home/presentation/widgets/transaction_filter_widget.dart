...
class _TransactionFilterWidgetState extends State<TransactionFilterWidget> {
  ...
  Widget build(BuildContext context) {
    final bool hasActiveFilters = widget.selectedCategoryId != null ||
            ...
            child: ListView(
              ...
              children: [
                if (widget.selectedCategoryId != null)
                  _buildFilterChip(
                    widget.categoriesCache[widget.selectedCategoryId]?.name ?? "Categoría",
                    () {
          ...
          return GestureDetector(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _getCategoryColor(category.color).withOpacity(isSelected ? 0.9 : 0.3),
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    ...
                    color: isSelected ? Colors.white : _getCategoryColor(category.color),
                    size: 20,
                  ),
      ...
      children: [
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final bool isSelected = widget.startDate != null &&
                  widget.endDate != null &&
        ...
        OutlinedButton.icon(
          ...
          icon: Icon(
            Icons.date_range,
            size: 16,
            color: widget.startDate != null ? AppTheme.primaryColor : AppTheme.textSecondaryColor,
          ),
          label: Text(
  ...
  List<Tuple2<DateTime, DateTime>> _splitMonthIntoWeeks(DateTime firstDay, DateTime lastDay) {
